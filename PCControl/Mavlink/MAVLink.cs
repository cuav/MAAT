...
namespace ArdupilotMega
{
    public partial class MAVLink
    {
        ...
        */
        ...
        public/*byte[]*/static void readlogPacketMavlink(BinaryReader br, out byte[] packet, out DateTime d)
        {
            byte[] temp = new byte[300];
            ...
            br.BaseStream.Read(datearray, 0, datearray.Length);
