...
//bool AP_Compass_HMC5843::_updated = false;
uint8_t AP_Compass_HMC5843::_base_config;
int AP_Compass_HMC5843::_raw_mag_x = 0;          ///< magnetic field strength along the X axis
int AP_Compass_HMC5843::_raw_mag_y = 0;          ///< magnetic field strength along the Y axis
int AP_Compass_HMC5843::_raw_mag_z = 0;          ///< magnetic field strength along the Z axis
...
bool AP_Compass_HMC5843::read_raw()
{
    ...
    {
    	Serial2.printf("x=%d y=%d z=%d\n", rx, ry, rz);
        // no valid data available
        //Serial.println("Check 2");
        return false;
    }

		//Serial.printf("RAW MAG:%i,%i,%i\n", ry, rx, -rz);
    _raw_mag_x = ry;//-rx;
    _raw_mag_y = rx;//ry;
    _raw_mag_z = -rz;//-rz;
...
bool AP_Compass_HMC5843::init(/*AP_PeriodicProcess *scheduler*/)
{
    delay(10);
    init_hardware();
    //scheduler->register_process( &AP_Compass_HMC5843::_update );
    return healthy;
}

// Public Methods //////////////////////////////////////////////////////////////
void AP_Compass_HMC5843::init_hardware()
{
...
//#if 0
        ...
        Serial2.print("mag_x: ");
        Serial2.print(_raw_mag_x);
        Serial2.print(" mag_y: ");
        Serial2.print(_raw_mag_y);
        Serial2.print(" mag_z: ");
        Serial2.println(_raw_mag_z);
        Serial2.print("CalX: ");
...
long AP_Compass_HMC5843::_compass_timer = 0;

// Read Sensor data

void AP_Compass_HMC5843::update(/*uint32_t tnow*/)
{
    ...
    if (!_updated)
    {
        ...
        _updated = read_raw();
        //if (!_updated)
        //	Serial.println("mag not updated");
    }
}
...
bool AP_Compass_HMC5843::read()
{
    if (!healthy)
    {
    		Serial.println("mag not healthy");
        return false;
    }
        ...
        //if (read_raw())
    {
        ...
        mag_x = _raw_mag_x * calibration[0] + _offset[0];
        mag_y = _raw_mag_y * calibration[1] + _offset[1];
        mag_z = _raw_mag_z * calibration[2] + _offset[2];
				//Serial.printf("Hello MAG %f %f %f\n");
        ...
        //rot_mag += _offset.get();
        //mag_x = rot_mag.x + _offset[0];
        //mag_y = rot_mag.y + _offset[1];
        //mag_z = rot_mag.z + _offset[2];
        return true;
    }
